...
def main(
    ...
    st.sidebar.title("Праздничное приложение для всех женщин из ДРБИС")
    ...
    st.markdown("<h2 style='text-align: center; '>Поздравляем с наступающим международным женским днём !</h2>", unsafe_allow_html = True)
    
    st.write("Прекрасны по весне цветы, но женщины еще прекрасней. В этот день желаем Вам любви и счастья, благополучия в семье, мужской заботы, удачи во всех делах и вдохновения в работе !")
    ...
    st.image('8mmm.gif')
    st.write("Кроме цветов, атрибут праздничного настроения, конечно же, шарики. Можете запускать их в любое время для улучшения настроения.")
    ...
    st.sidebar.info("Разработчик - Братковский Евгений (ОАиУД ДРБИС).")
